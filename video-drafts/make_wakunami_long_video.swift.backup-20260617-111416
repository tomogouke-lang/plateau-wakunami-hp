...
let videoOnlyURL = outDir.appendingPathComponent("wakunami-long-draft-v8-video-only.mp4")
let finalURL = outDir.appendingPathComponent("wakunami-long-draft-v8.mov")
...
let scenes: [Scene] = [
    Scene(imageName: "01-building-clean.jpg", title: "涌波での一日の流れ", subtitle: "初めての方にも分かりやすく、送迎から帰宅までをご紹介します。", seconds: 7, rotateDegrees: 0),
    Scene(imageName: "01-building-clean.jpg", title: "建物・入口", subtitle: "実際の建物の様子です。まずは、見学だけでも大丈夫です。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "pickup-assistance-ai-cropped.png", title: "送迎", subtitle: "朝はご自宅までお迎えに伺います。乗り降りも職員がそばでお手伝いします。", seconds: 9, rotateDegrees: 0),
    ...
    Scene(imageName: "footbath-no-face-ai.png", title: "リラクゼーション", subtitle: "足湯など、体を休める時間もあります。", seconds: 8, rotateDegrees: 0),
    ...
    Scene(imageName: "11-bath-clean.jpg", title: "入浴", subtitle: "入浴は安全に配慮し、必要なところを職員がお手伝いします。", seconds: 9, rotateDegrees: 0),
    Scene(imageName: "lunch-table-no-face-ai.png", title: "昼食", subtitle: "昼食は、落ち着いて食べられる時間にしています。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "lunch-support-hands-ai.png", title: "食事の見守り", subtitle: "食べやすさや体調の変化にも気を配ります。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "recreation-hands-ai.png", title: "午後の活動", subtitle: "午後は趣味活動やレクリエーションなど、その方に合わせた過ごし方を大切にしています。", seconds: 9, rotateDegrees: 0),
    Scene(imageName: "recreation-hands-ai.png", title: "脳トレ・趣味活動", subtitle: "手先を使う活動や考える活動も、無理のない範囲で行います。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "recreation-hands-ai.png", title: "それぞれのペースで", subtitle: "参加する日も、静かに過ごす日もあります。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "seasonal-recreation-no-face-ai.png", title: "季節の行事", subtitle: "いつもと少し違う、大きめのレクリエーションを行うこともあります。", seconds: 8, rotateDegrees: 0),
    Scene(imageName: "pickup-assistance-ai-cropped.png", title: "帰宅", subtitle: "夕方はご自宅までお送りします。必要に応じて、その日の様子もお伝えします。", seconds: 9, rotateDegrees: 0),
    Scene(imageName: "01-building-clean.jpg", title: "見学だけでも大丈夫です", subtitle: "涌波のホームページから、施設の様子をご確認ください。\ntomogouke-lang.github.io/plateau-wakunami-hp/", seconds: 9, rotateDegrees: 0),
]
